...
<div class="container">
    ...
    <form action="ejercicio10.jsp" method="post">
        ...
        <input type="number" id="chocolate" name="chocolate" min="0" max="100" value="<%= request.getParameter("chocolate") != null ? request.getParameter("chocolate") : 0 %>">
        <br>
        <label for="fresa">Porcentaje de fresa:</label>
        <input type="number" id="fresa" name="fresa" min="0" max="100" value="<%= request.getParameter("fresa") != null ? request.getParameter("fresa") : 0 %>">
        <br>
        <label for="vainilla">Porcentaje de vainilla:</label>
        <input type="number" id="vainilla" name="vainilla" min="0" max="100" value="<%= request.getParameter("vainilla") != null ? request.getParameter("vainilla") : 0 %>">
        <br>
    ...
    <%
        ...
        if (request.getMethod().equalsIgnoreCase("POST")) {
            try {
                ...
                // Validar que la suma de los porcentajes sea menor o igual a 100
        ...
        // Si no hay error, mostramos la tarrina
